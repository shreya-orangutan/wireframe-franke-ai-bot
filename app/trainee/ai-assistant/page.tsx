...
import { AlertCircle, CheckCircle2, Plus, Info } from "lucide-react"
import { Alert, AlertDescription, AlertTitle } from "@/components/ui/alert"
import type { Session } from "@/lib/schemas"
import { Empty, EmptyHeader, EmptyTitle, EmptyDescription, EmptyContent, EmptyMedia } from "@/components/ui/empty"

export default function TraineeAIAssistantPage() {
  ...
  if (currentSession && !currentSession?.videoWatched && !showGuidelines) {
    return (
            ...
            <div className="flex items-center justify-between">
              <PageHeader
                ...
                breadcrumbs={[
                  ...
                  { label: "AI Assistant", href: "/trainee/ai-assistant" },
                  { label: "Session" },
                ]}
              />
              <Badge variant="secondary">Watching Video</Badge>
            </div>
  ...
  return (
    <AppLayout>
      {!currentSession ? (
        <div className="space-y-6">
          <PageHeader
            ...
            description="Access your assigned materials and interact with the AI chatbot"
            breadcrumbs={[{ label: "Trainee", href: "/trainee" }, { label: "AI Assistant" }]}
            actions={
          ...
          <Alert>
            ...
            <AlertTitle>Training Materials Access</AlertTitle>
            <AlertDescription>
              Your trainer has assigned training materials to you. Click &quot;Start Training&quot; to begin a session
              and access the AI assistant for help.
            </AlertDescription>
          </Alert>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>View your completed and in-progress training sessions</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <Empty className="border">
                  <EmptyContent>
                    <EmptyHeader>
                      ...
                      <EmptyTitle>No training sessions yet</EmptyTitle>
                      <EmptyDescription>Click &quot;Start Training&quot; to begin your first session</EmptyDescription>
                    </EmptyHeader>
                    <Button onClick={() => setStartModalOpen(true)}>
                      <Plus className="h-4 w-4 mr-2" />
                      Start Training
      ...
      ) : showGuidelines && !currentSession?.guidelinesAccepted ? (
        <div className="space-y-6">
          <PageHeader
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            />
            <Badge variant="default">Video Complete</Badge>
          </div>
          ...
          <Alert>
            ...
            <AlertDescription>
              You can now chat with the AI assistant about the training material. The video is available for reference.
            </AlertDescription>
          </Alert>
