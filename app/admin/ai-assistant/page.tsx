...
export default function AdminAIAssistantPage() {
  ...
  const filteredSessions = sessions.filter((s) => {
    const matchesStatus = s.status === "in-progress" || s.status === "completed"
      ...
      <AppLayout>
        <div className="space-y-6">
          <PageHeader
            ...
            description="Start a new training session or review past sessions"
              ...
              {filteredSessions.length > 0 ? (
                ...
                <p className="text-sm text-muted-foreground text-center py-8">
                  {dateRange?.from
                    ...
                    : 'No training sessions yet. Click "Start Training" to begin your first session.'}
                </p>
              )}
            </CardContent>
          </Card>
  ...
  // Show video or chat
  return (
    <AppLayout hideSidebar={!currentSession?.videoWatched}>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <PageHeader
