...
export default function AIAssistantPage() {
  ...
  // If no session, show session history with start button
  if (!currentSession) {
    return (
      <AppLayout>
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-balance">AI Assistant</h1>
              <p className="text-muted-foreground">Start a training session with AI guidance</p>
            </div>
  ...
  if (showGuidelines && !currentSession?.guidelinesAccepted) {
    return (
      <AppLayout>
        <div className="space-y-6">
          <div>
            <h1 className="text-3xl font-bold text-balance">Training Guidelines</h1>
            <p className="text-muted-foreground">Please read and accept before continuing</p>
          </div>
  ...
  return (
    <AppLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-balance">Training Session</h1>
            <p className="text-muted-foreground">{currentSession?.productName}</p>
          </div>
        ...
        {!currentSession?.videoWatched ? (
          ...
          <div className="space-y-4">
            <Alert>
              ...
              <AlertDescription>You can now chat with the AI assistant about the training material.</AlertDescription>
            </Alert>
